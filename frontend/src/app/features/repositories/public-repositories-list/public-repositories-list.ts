...
import { PublicRepositoryService } from '../services/public-repository.service';

@Component({
  selector: 'app-public-repositories-list',
  standalone: false,
  templateUrl: './public-repositories-list.html',
  styleUrl: './public-repositories-list.css',
  providers: [MessageService]
})
export class PublicRepositoriesList {
  badge!: string; 
  ...
  searchTerm: string = '';
  selectedSort: string = 'numberOfPulls,desc';
  ...
  constructor(
    ...
    private repositoryService: PublicRepositoryService,
